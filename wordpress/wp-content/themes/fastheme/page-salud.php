...
<main class="pt-20">
    <!-- HERO -->
    <section class="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-fas-leaf via-[#5a8a69] to-[#4a7a59]">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32 w-full">
            <div class="max-w-3xl">
                ...
                <h1 class="reveal reveal-delay-1 font-display text-5xl md:text-6xl lg:text-7xl text-white mb-6 leading-[1.15]">
                    Salud <span class="italic text-fas-accent">preventiva</span> para todos
                </h1>
                <p class="reveal reveal-delay-2 text-xl text-white/80 mb-10 max-w-xl font-light leading-relaxed">
                    Cuidamos la salud de las comunidades mediante atención médica básica y programas de prevención.
                </p>
                <div class="reveal reveal-delay-3 flex flex-wrap gap-4">
                    <a href="#como-ayudamos" class="btn-fas px-9 py-4 bg-white text-fas-leaf rounded-full font-medium shadow-xl">Cómo funcionamos</a>
    ...
    <section class="py-10 bg-white border-b border-fas-sand/50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div><span class="block font-display text-4xl text-fas-leaf mb-2">300+</span><span class="text-gray-500 font-light">Chequeos realizados</span></div>
                <div><span class="block font-display text-4xl text-fas-leaf mb-2">150+</span><span class="text-gray-500 font-light">Niños atendidos</span></div>
                <div><span class="block font-display text-4xl text-fas-leaf mb-2">4</span><span class="text-gray-500 font-light">Comunidades</span></div>
                <div><span class="block font-display text-4xl text-fas-leaf mb-2">100%</span><span class="text-gray-500 font-light">Gratuito</span></div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="reveal reveal-delay-3 bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all card-organic">
                    <div class="w-16 h-16 bg-fas-leaf/10 rounded-2xl flex items-center justify-center mb-6">
                        <i class="fas fa-stethoscope text-3xl text-fas-leaf"></i>
                    </div>
                    <h3 class="font-display text-2xl text-gray-800 mb-4">Atención médica básica</h3>
                    <p class="text-gray-500 font-light leading-relaxed">Brindamos consultas médicas generales y derivaciones a especialistas cuando es necesario.</p>
                </div>
                <div class="reveal reveal-delay-4 bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all card-organic">
                    <div class="w-16 h-16 bg-fas-primary/10 rounded-2xl flex items-center justify-center mb-6">
                        <i class="fas fa-pills text-3xl text-fas-primary"></i>
                    </div>
                    <h3 class="font-display text-2xl text-gray-800 mb-4">Medicamentos</h3>
                    <p class="text-gray-500 font-light leading-relaxed">Entregamos medicamentos gratuitos a familias que no pueden costearlos.</p>
                </div>
                <div class="reveal reveal-delay-5 bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all card-organic">
                    <div class="w-16 h-16 bg-fas-accent/10 rounded-2xl flex items-center justify-center mb-6">
                        <i class="fas fa-heartbeat text-3xl text-fas-accent"></i>
                    </div>
                    <h3 class="font-display text-2xl text-gray-800 mb-4">Prevención</h3>
                    <p class="text-gray-500 font-light leading-relaxed">Campañas de vacunación, controles de crecimiento y educación en hábitos saludables.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-32 px-6 bg-white relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto relative">
            <div class="text-center mb-16">
                ...
                <div class="reveal reveal-delay-1 w-16 h-px bg-gradient-to-r from-fas-accent to-fas-accent-warm mx-auto mb-6"></div>
                <h2 class="reveal reveal-delay-2 font-display text-4xl md:text-5xl text-gray-800 mb-6">Proyectos de Salud</h2>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
    ...
    <!-- CTA -->
    <section class="py-32 px-6 bg-gradient-to-br from-fas-leaf to-[#4a7a59] relative overflow-hidden">
        <div class="max-w-4xl mx-auto text-center relative">
            <h2 class="reveal font-display text-4xl md:text-5xl text-white mb-6">Apoya nuestra labor médica</h2>
            <p class="reveal reveal-delay-1 text-white/80 text-lg font-light mb-8">Tu apoyo nos ayuda a seguir brindando atención médica gratuita.</p>
            <a href="<?php echo get_permalink(get_page_by_path('apoyanos')); ?>" class="reveal reveal-delay-2 btn-fas px-9 py-4 bg-white text-fas-leaf rounded-full font-medium shadow-xl">Donar ahora</a>
        </div>
    </section>
</main>
